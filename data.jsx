...
const PMP_TRACKS = [
  ...
  { n: 9,  title: "Premier Riff de Printemps", sub: "(Session 27 mars · live au labo)",              dur: "—:—", bpm: 110, dci: "Pollen 0,5 µm",           key: "B-min",  type: "live",   audio: "assets/audio/audio-2026-03-27.mp3",     featured: true },
  { n: 10, title: "Hotte à Flux Freestyle",   sub: "(Prépa Lab · take 1 · improvisation ISO 5)",     dur: "—:—", bpm: 92,  dci: "Improvisé ad lib",        key: "F-min",  type: "freestyle", audio: "assets/audio/prepa-lab-freestyle.mp3", featured: true },
  { n: 11, title: "Excipient Cypher",         sub: "(Prépa Lab · take 2 · battle de rimes pharma)",  dur: "—:—", bpm: 98,  dci: "Mannitol 5%",             key: "A-min",  type: "freestyle", audio: "assets/audio/prepa-lab-freestyle-2.mp3", featured: true },
  { n: 12, title: "Posologie Slam",           sub: "(Prépa Lab · take 3 · slam des doses)",          dur: "—:—", bpm: 104, dci: "Caféine 200mg",           key: "C-min",  type: "freestyle", audio: "assets/audio/prepa-lab-freestyle-3.mp3", featured: true },
  { n: 13, title: "Charlotte Stéréo",         sub: "(Prépa Lab · take 4 · headbang en EPI)",         dur: "—:—", bpm: 100, dci: "Air filtré HEPA",         key: "D-min",  type: "freestyle", audio: "assets/audio/prepa-lab-freestyle-4.mp3", featured: true },
  { n: 14, title: "Operation Pharma",         sub: "(Single officiel)",                              dur: "—:—", bpm: 140, dci: "Bleu de méthylène 1%",    key: "A-min",  type: "single", audio: "assets/audio/operation-pharma.mp3",     featured: true },
  { n: 15, title: "Awake in Pharmaco",        sub: "(Single officiel)",                              dur: "—:—", bpm: 132, dci: "Caféine 200mg",           key: "C-min",  type: "single", audio: "assets/audio/awake-in-pharmaco.mp3",    featured: true },
  { n: 16, title: "Pharmaco Storm",           sub: "(Single officiel)",                              dur: "—:—", bpm: 156, dci: "Furosémide 40mg IV",      key: "D-min",  type: "single", audio: "assets/audio/pharmaco-storm.mp3",       featured: true },
  { n: 17, title: "Pharmacobar United",       sub: "(Hymne · feat. Equipe de Garde)",                dur: "—:—", bpm: 128, dci: "Solution buvable QSP",    key: "G-maj",  type: "anthem", audio: "assets/audio/pharmacobar-united.mp3",   featured: true },
  { n: 18, title: "Posologie Maximale",       sub: "(Toxique Mix · démo)",                           dur: "4:32", bpm: 142, dci: "Paracétamol 4g/j",       key: "E-min",  type: "death-pop"  },
  { n: 19, title: "Hotte à Flux Sépulcral",   sub: "(instrumental ISO 5 · démo)",                    dur: "5:18", bpm: 96,  dci: "Air ambiant filtré",     key: "C#-min", type: "doom"       },
  { n: 20, title: "AMM Refusée",              sub: "feat. Comité d'Éthique · démo",                  dur: "3:47", bpm: 168, dci: "Placebo HCl",            key: "G-maj",  type: "pop-metal"  },
  { n: 21, title: "Préparation Magistrale",   sub: "(Sang d'Excipient · démo)",                      dur: "6:24", bpm: 80,  dci: "QSP 100mL",              key: "F-min",  type: "ballade"    },
  { n: 22, title: "DCI",                      sub: "Damnation Comprimée Iatrogène · démo",           dur: "4:11", bpm: 160, dci: "Variable",               key: "A-min",  type: "thrash-pop" },
  { n: 23, title: "Lyophilise mon Cœur",      sub: "(Reconstitution Extemporanée · démo)",           dur: "3:58", bpm: 88,  dci: "Glace carbonique",       key: "D-min",  type: "power-ballade"},
  { n: 24, title: "ZAC Funéraire",            sub: "(Zone à Atmosphère Crématoire · démo)",          dur: "5:47", bpm: 132, dci: "Azote liquide",          key: "B-min",  type: "industrial" },
  { n: 25, title: "Pilulier Sépulcral",       sub: "(Lundi / Mardi / Mercredi / Mort · démo)",       dur: "4:03", bpm: 150, dci: "Polypharmacie",          key: "E-min",  type: "speed-pop"  },
  { n: 26, title: "QSP 666",                  sub: "(Quantité Suffisante Pour l'Au-delà · démo)",    dur: "5:33", bpm: 178, dci: "Excipient ad lib.",      key: "F#-min", type: "black-pop"  },
  { n: 27, title: "Charlotte de la Mort",     sub: "(Couvre-Chef Stérile · démo)",                   dur: "3:21", bpm: 200, dci: "EPI complet",            key: "C-maj",  type: "grindpop"   },
  { n: 28, title: "Stérile mais Hostile",     sub: "(autoclave 121°C · démo)",                       dur: "4:45", bpm: 124, dci: "Vapeur saturée",         key: "G-min",  type: "groove"     },
  { n: 29, title: "Codéine Inquisition",      sub: "(Liste I, Cadenas II · démo)",                   dur: "7:12", bpm: 72,  dci: "Codéine phosphate",      key: "D-min",  type: "épopée"     },
];
...
const PMP_MEMBERS = [
  ...
  { stage: "MARIE",        role: "Batterie · métronome humain",                      desc: "120 BPM constants, sans dire un mot. La chimio sort à l'heure.",                                    icon: "drums",   accent: "mustard" },
  ...
  { stage: "PATRICIA « PAT »", role: "Mascotte merch de Noël",                       desc: "Pull moche garanti à chaque tournée. Reine incontestée du Christmas sweater.",                     icon: "star",    accent: "pink"    },
  ...
  { stage: "LUCILLE",      role: "Chœurs folk-rock",                                 desc: "Harmonie à 3 voix au-dessus du riff. Touche americana sur fond pharma.",                            icon: "feather", accent: "mustard" },
  ...
  { stage: "JEAN-KÉVIN",   role: "Interludes · escape-game master",                  desc: "Accent aigu, pas le même que l'autre. Anime les transitions live façon escape-game pharma.",        icon: "key",     accent: "mustard" },
  ...
  { stage: "MARION",       role: "Claviers atmosphériques · harmonies ambient",      desc: "Nappes pastel par-dessus les morceaux durs. Le contraste, c'est la signature.",                     icon: "keys",    accent: "lilac"   },
  { stage: "PAULINE",      role: "Chanteuse pop-rock secondaire",                    desc: "Voix qui répond à Julie. Le tag-team vocal du groupe.",                                            icon: "mic",     accent: "orange"  },
  { stage: "MANON",        role: "Guitare lead",                                     desc: "Solos en wah-wah pendant les pauses Excipient. La main droite la plus rapide du service.",          icon: "guitar",  accent: "mustard" },
  { stage: "TITIANE",      role: "Violoncelle symphonique",                          desc: "Basse mélodique grave. Posologie de tristesse pour les ballades.",                                  icon: "cello",   accent: "pink"    },
